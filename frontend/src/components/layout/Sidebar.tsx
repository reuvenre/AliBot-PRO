...
import {
  ...
  Shield, ShieldAlert, Ticket, LayoutTemplate, ExternalLink, CalendarClock, BookOpen, Gift,
  Brain,
} from 'lucide-react';
...
const NAV_SECTIONS = [
  {
    ...
    items: [
      ...
      { href: '/scheduled',  label: 'פוסטים מתוזמנים', icon: CalendarClock },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/incentives', label: 'קמפייני בונוס', icon: Gift },
    ],
  },
  {
    title: 'נתונים',
    items: [
      ...
      { href: '/optimizer', label: 'המוח הלומד', icon: Brain },
