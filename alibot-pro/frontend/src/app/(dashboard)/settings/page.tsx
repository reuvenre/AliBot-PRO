...
import { User, ShoppingBag, Plug, ShieldCheck, Bell } from 'lucide-react';
...
type Tab = 'profile' | 'marketplaces' | 'integrations' | 'security' | 'notifications';
...
const TABS: { id: Tab; label: string; icon: React.ElementType; desc: string }[] = [
  ...
  { id: 'integrations',  label: 'אינטגרציות',     icon: Plug,         desc: 'Telegram ו-ערוצים' },
  ...
  return (
    <div className="flex gap-6 min-h-0">
      ...
      <aside className="w-52 shrink-0 space-y-1">
        <p className="text-[10px] font-semibold text-white/25 uppercase tracking-wider px-3 mb-3">הגדרות</p>
      ...
      <div className="flex-1 min-w-0">
        <div className="mb-6">
          <h1 className="text-xl font-bold text-white">{active.label}</h1>
